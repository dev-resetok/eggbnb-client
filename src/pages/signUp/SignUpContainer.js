...
const SignUpContainer = () => {
    ...
    const checkEmailInfo = async (props) => {
        console.log(props)
        try{
            const response = await fetch("https://port-0-eggbnb-server-ly8jjkrt043c2434.sel5.cloudtype.app/user/checkEmail", {
                method : "POST",
    ...
    const checkUserIdInfo = async (props) => {
        console.log(props)
        try{
            const response = await fetch("https://port-0-eggbnb-server-ly8jjkrt043c2434.sel5.cloudtype.app/user/checkUserId", {
                method : "POST",
                body : JSON.stringify(props),
                headers : {
                    "Content-Type" : "application/json; charset=utf-8"
    ...
    return (
        <S.SignUpWrapper>
            <S.Form onSubmit={handleSubmit(async (data)=>{
                ...
                //회원가입 로직
                await fetch('https://port-0-eggbnb-server-ly8jjkrt043c2434.sel5.cloudtype.app/user/signUp', {
                    method : 'POST',
                    headers : {
